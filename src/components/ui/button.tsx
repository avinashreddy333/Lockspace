  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        locked:
          "bg-locked/10 text-locked border border-locked/30 hover:bg-locked/20",
        unlocked:
          "bg-unlocked/10 text-unlocked border border-unlocked/30 hover:bg-unlocked/20 hover:shadow-[0_0_16px_hsl(var(--unlocked)/0.3)]",
        warning:
          "bg-warning/10 text-warning border border-warning/30 hover:bg-warning/20",
        hero:
          "bg-primary text-primary-foreground shadow-lg hover:shadow-glow hover:bg-primary/90 transition-all duration-300",
      },
      size: {
